...
% Iteration 2 - Changing The Spar Configuration (Front and Rear Spar)
...
h_st = 30;            % Height (mm)
w_st_flange = 15;     % Flange Width (mm) ~ 0.4 * h
t_st = 2.8;           % Stringer Thickness (mm)
...
% Front Spar Cap
w_f_cap = 127.5;         % Width effective (mm)
t_f_cap = 4.45;          % Thickness effective (mm)
A_sparf = w_f_cap * t_f_cap; % Area ~520 mm^2

% Rear Spar Cap
w_r_cap = 61.15;         % Width effective (mm)
t_r_cap = 4.45;          % Thickness effective (mm)
