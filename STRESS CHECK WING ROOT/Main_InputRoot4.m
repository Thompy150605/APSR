...
w = [Wall('1_2',findP(p,'1'),findP(p,'2'),Al2024,tu); 
    ...
    Wall('10_11',findP(p,'10'),findP(p,'11'),Al7075,2.75);%rspar
    Wall('11_12',findP(p,'11'),findP(p,'12'),Al2024,tl);
    Wall('12_13',findP(p,'12'),findP(p,'13'),Al2024,tl);
    Wall('13_14',findP(p,'13'),findP(p,'14'),Al2024,tl);
    Wall('14_15',findP(p,'14'),findP(p,'15'),Al2024,tl);
    Wall('15_16',findP(p,'15'),findP(p,'16'),Al2024,tl);
    Wall('16_17',findP(p,'16'),findP(p,'17'),Al2024,tl);
    Wall('17_18',findP(p,'17'),findP(p,'18'),Al2024,tl);
    Wall('18_19',findP(p,'18'),findP(p,'19'),Al2024,tl);
    Wall('19_20',findP(p,'19'),findP(p,'20'),Al2024,tl);
    Wall('20_1',findP(p,'20'),findP(p,'1'),Al7075,3.75);];%fspar
